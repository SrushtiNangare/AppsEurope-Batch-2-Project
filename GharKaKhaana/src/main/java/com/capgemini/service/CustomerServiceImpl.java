...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Order viewOrderStatus(int orderId) throws NoSuchOrderException, NoSuchCustomerException {
    	...
    	try {
            ...
            if(order.get() !=null) {
                ...
                throw new NoSuchCustomerException("Customer with "+orderId+" is not found"); /*Throwing and handling exception */
            }
        }
        return null;
    }
    ...
    public Order modifyOrder(int foodId) throws NoSuchOrderException {
        Order order= findOrderById(foodId); /* calling method findVendorById */
        if(order != null) {
            orderRepository.save(order);
            return order;
        }else
            throw new NoSuchOrderException("Food with "+foodId+" is not found"); /*Throwing and handling exception */
    }
